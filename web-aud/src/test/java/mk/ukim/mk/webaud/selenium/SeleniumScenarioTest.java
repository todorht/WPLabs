...
public class SeleniumScenarioTest {
    ...
    public void testScenario() throws Exception{
        ProductPage productPage = ProductPage.to(this.driver);
        productPage.assertElements(0,0,0,0,0);
        LoginPage loginPage = LoginPage.openLogin(this.driver);

        ProductPage productsPage = LoginPage.doLogin(driver,loginPage, adminUser.getUsername(), adminUser.getPassword());
        productsPage.assertElements(0,0,0,0,1);

        productPage = AddOrEditProduct.addProduct(this.driver,"test","100","5",c2.getName(),m2.getName());
        productsPage.assertElements(1,1,1,1,1);

        productPage = AddOrEditProduct.addProduct(this.driver,"test1","200","4",c1.getName(),m2.getName());
        ...
        productsPage = LoginPage.doLogin(this.driver, loginPage, regularUser.getUsername(), regularUser.getPassword());
