...
const ProductEdit = (props) =>{
    ...
    const onFormSubmit = (e) =>{
        ...
        const manufacturer = formData.manufacturer !== 0 ? formData.manufacturer: props.product.manufacturer;
                    ...
                    <div className="form-group">
                        ...
                        <select name="category" className="form-control" onChange={handleChange}>
                            {props.categories.map((term) => {
                                    if(props.product.category !== undefined && props.product.category.id === term.id)
                    ...
                    <div className="form-group">
                        ...
                        <select name="manufacturer" className="form-control" onChange={handleChange}>
                            {props.manufacturers.map((term) =>{
                                    if(props.product.manufacturer !== undefined && props.product.manufacturer.id === term.id)
