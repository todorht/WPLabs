...
public class AddOrEditProduct extends AbstractPage{
    ...
    public static ProductPage addProduct(WebDriver driver, String name, String price, String quantity, String category, String manufacturer){
    ...
    public static ProductPage editProduct(WebDriver driver, WebElement editButton, String name, String price, String quantity, String category, String manufacturer) {
        editButton.click();
