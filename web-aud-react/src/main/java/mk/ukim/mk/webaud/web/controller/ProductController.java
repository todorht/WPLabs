...
public class ProductController {
    ...
    public String saveProduct(@RequestParam(required = false) Long id, @RequestParam String name,@RequestParam Double price, @RequestParam Integer quantity,
        ...
        try {
            if(id!=null) this.productService.edit(id, name, price, quantity, category, manufacturer);
            else this.productService.save(name, price, quantity, category, manufacturer);
            return "redirect:/products";
        }catch (RuntimeException e){
            return "redirect:/add?error=vnesi gi site informacii";
        }
    }
